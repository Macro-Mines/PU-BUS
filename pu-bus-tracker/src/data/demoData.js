...
export const ROUTES = {
  university_route: {
    ...
    path: [
      ...
      { lat: 12.028334, lng: 79.856575 }, // Checkpoint KVS
...
// Simulated active buses for demo mode
export const DEMO_BUSES = {
  bus_001: {
    bus_id: 'bus_001',
    bus_number: 'PU-01',
    route_id: 'university_route',
    driver_name: 'Rajesh K.',
    current_location: { lat: 12.020523, lng: 79.856310, heading: 0, speed: 20 },
  ...
  bus_002: {
    ...
    current_location: { lat: 12.022946, lng: 79.847169, heading: 0, speed: 18 },
  ...
  bus_003: {
    ...
    route_id: 'university_route',
    driver_name: 'Arun P.',
    current_location: { lat: 12.029188, lng: 79.852368, heading: 0, speed: 15 },
